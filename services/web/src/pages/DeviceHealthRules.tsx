  ...
  return (
    <div className="h-full flex flex-col bg-slate-100">
      <header className="px-6 md:px-8 py-5 bg-white border-b border-slate-200 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Машин эрүүл мэнд</h1>
          <p className="text-sm text-slate-500 mt-0.5">
            Холболт, хүчдэл, GPS чанарын босгуудыг тодорхойлоход систем энэ дагуу
            автоматаар машин бүрийн эрүүл мэндийг хянана. Дохиолол явуулах журам нь
            "Дохиоллын дүрэм" хуудаснаас тохируулагдана.
          </p>
        </div>
